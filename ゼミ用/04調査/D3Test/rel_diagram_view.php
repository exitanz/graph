    ...
    <ul class="nav nav-tabs">
      ...
      <div class="container bg-light">
        <div class="text-right">
          <button class="btn btn-warning">一覧に戻る<i class="fas fa-reply"></i></button>
        </div>
      </div>
</body>
...
<meta charset="utf-8">
<link rel="stylesheet" href="./lib/css/style.css">
<svg width="980" height="860" style="background-color:#ddd"></svg> <!-- ちょっと広くして色つけた-->
...
<div id="sidebar">
  <section id="side_setting">
    ...
    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
      <button type="button" class="btn btn-primary">Actor<i class="fa fa-user"></i></button>
      <button type="button" class="btn btn-success">Line<i class="fas fa-random"></i></button>
      <div class="btn-group" role="group">
        <button id="btnGroupDrop1" type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Other
        </button>
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
          <a class="dropdown-item" href="#">相関図を保存</a>
