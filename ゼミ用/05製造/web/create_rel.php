            ...
            <aside class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                <div class="card">
                    <article class="card-body">
                        <h4 class="card-title text-center mb-4 mt-1">関係性登録</h4>
                        <hr>
                        <form action="../api/src/controller/LoginControler.php" method="POST">
                            <div class="form-group">
                                <br />
                                <div class="alert alert-danger">関係性名は100文字以内で入力してください<br /></div>
                                <br />
                                <table class="table">
                                    <th></th>
                                </table>
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="関係性名を入力してください。" type="text" name="acter_name">
                                </div>
                            </div>
                            <br />
